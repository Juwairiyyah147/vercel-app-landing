...
const Features = () => {
    return (
        <section className="service" id="features">
            <div className="img-cont">
                <img src="assets/iPhone-13-Pro-Front.png" alt="Phone" />
            ...
            <div className="container-sec">
                ...
                <div className="hd">
                    <span> FEATURES </span>
                        <h2 className="heading1"> Uifry Premium</h2>
                    </div>
                    <div className="fts">
                        <div className="f1">

                            <div className="ft-title-container">
                                ...
                                <h3 className="ft-heading">Budgeting Intervals</h3>
                            </div>
